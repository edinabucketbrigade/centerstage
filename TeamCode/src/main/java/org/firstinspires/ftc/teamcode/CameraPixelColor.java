...
public class CameraPixelColor extends OpenCvPipeline {
    ...
    public static int MINIMUM_YELLOW_VALUES = 40;
    public static int MINIMUM_GREEN_VALUES = 80;
    public static int MINIMUM_PURPLE_VALUES = 40;
    public static int MAXIMUM_WHITE_VALUES = 20;
    ...
    public static int MINIMUM_YELLOW_HUE = 40;
    public static int MINIMUM_GREEN_HUE = 80;
    public static int MINIMUM_PURPLE_HUE = 115;
    public static int MAXIMUM_WHITE_HUE = 255;
    public static int MAXIMUM_YELLOW_HUE = 70;
    public static int MAXIMUM_GREEN_HUE = 100;
    ...
    public Mat processFrame(Mat input) {
        ...
        MINIMUM_WHITE = new Scalar(MINIMUM_WHITE_HUE, MINIMUM_WHITE_VALUES, MINIMUM_WHITE_VALUES);
        MAXIMUM_WHITE = new Scalar(MAXIMUM_WHITE_HUE, MAXIMUM_WHITE_VALUES, MAXIMUM_WHITE_VALUES);
